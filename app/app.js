...
.constant('APP_API_KEY', 'APP API KEY GOES HERE')
...
.factory('httpInterceptor', [
	'$location', '$q', '$injector', 'INSTANCE_URL', 'twitterService',

	function ($location, $q, $injector, INSTANCE_URL, twitterService) {
...
.controller('HeaderCtrl', [
	'$scope', '$mdSidenav', '$mdUtil', '$http', '$location', '$rootScope', 'twitterService',

	function ($scope, $mdSidenav, $mdUtil, $http, $location, $rootScope, twitterService) {
  ...
  $("#txtBookSearch").autocomplete({
    ...
    .autocomplete('instance')._renderItem = function(ul, item) {
      ...
      var img = $('<image class="imageClass" src=' + item.small_image + ' alt= ""' + '/>');
			...
			var img = $('<image class="imageClass" src= "app/images/not_found.png" alt= "not found"/>')
		}
